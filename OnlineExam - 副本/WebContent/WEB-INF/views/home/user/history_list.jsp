	...
	<div class="tm_main">
        ...
        <div class="tm_container">
        	<div class="tm_navtitle">
				<h1>历史测试</h1>
                <span>历史测试，请选择以下列表中我参加过的测试进行详情查看。</span>
            </div>
        </div>
        	...
        	<table width="100%" cellpadding="10" border="0" class="tm_table_list">
                ...
                <tbody>
					...
					<tr>
						...
						<td>
							<a href="review_exam?examId=${history.exam.id }&examPaperId=${history.id}" target="_blank" class="tm_btn tm_btn_primary" style="text-decoration:none;color:white;" >review</a>
						</td>
					</tr>
					</c:forEach>
                </tbody>

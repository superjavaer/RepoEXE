			...
			<script type="text/javascript">
				var tm = {
					startExam : function(e){
						...
						html.push('	<p style="line-height:20px">确定要开始答题吗？</p>');
						...
						<tbody>
							...
							<c:forEach items="${examList }" var = "exam">
								<tr id="tr-${exam.id }" data-key="${exam.id }">
										...
										<td ><button class="tm_btn tm_btn_primary" onclick="tm.startExam('tr-${exam.id }');">开始测试</button></td>
								</tr>
							</c:forEach>	

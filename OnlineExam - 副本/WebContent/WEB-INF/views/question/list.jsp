	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td><input type="text" id="add-title" name="title" class="wu-text easyui-validatebox"  ></td>
            </tr>
<%------------------------------------------------------------------------------------------------------------%>
            <tr>
                <td width="60" align="right">习题图片:</td>
                <td valign="middle">
            ...
            <tr>
                <td width="60" align="right">路径:</td>
                <td><input type="text" id="add-photo" name="photo" value=""  class="wu-text " /></td>
            </tr>
<%------------------------------------------------------------------------------------------------------------%>
            <tr>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
                <td align="right">试题题目:</td>
                <td><input type="text" id="edit-title" name="title" class="wu-text easyui-validatebox"  ></td>
            </tr>
            <tr>
                <%------------------------------------------------------------------------------------------------------------%>
            ...
            <tr>
                <td width="60" align="right">习题图片:</td>
                <td valign="middle">
                    <img id="edit-preview-photo" style="float:left;" src="" width="100px">
                    <a style="float:left;margin-top:40px;" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-upload" onclick="uploadPhoto()" plain="true">上传图片</a>
                </td>
            </tr>
            <tr>
                <td width="60" align="right">路径:</td>
                <td><input type="text" id="edit-photo" name="photo" value=""  class="wu-text " /></td>
            </tr>
            <%------------------------------------------------------------------------------------------------------------%>
...
<input type="file" id="photo-file" style="display:none;" onchange="upload_photo()">
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
            ...
            //添加习题图片
            { field:'photo',title:'习题图片',width:100,align:'center',formatter:function(value,row,index){
